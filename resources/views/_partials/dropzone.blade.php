<label for="dropzone-file" id="dropzone-label" class="d-flex flex-column align-items-center justify-content-center w-100 rounded-3 position-relative overflow-hidden @error('foto') border border-danger @enderror" style="height: 19.5rem; cursor: pointer;">
