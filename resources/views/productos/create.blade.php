    ...
    <form id="formProductos" method="POST" action="{{ route('productos.store') }}" enctype="multipart/form-data">
        ...
        <div class="row g-3 justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-black">
                        <h5 class="mb-0 mt-3"><small><i class="bi bi-flask me-2"></i></small>Información de Producción</h5>
                    </div>
                    <div class="card-body">
                        <!-- Nombre -->
                        <x-input-group 
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header text-black">
                        <h5 class="mb-0 mt-3"><small><i class="bi bi-image me-2"></small></i>Foto</h5>
                    </div>
                    <div class="card-body">
