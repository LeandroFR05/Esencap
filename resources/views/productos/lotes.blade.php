...
@section('content')
    ...
    @component('components.cards')
        @slot('titulo')
            <i class="bi bi-clock-history me-2"></i>Lotes de {{ $producto->nombre }}
        @endslot
        ...
        @slot('footer')
            <div class="d-flex justify-content-between align-items-center">
                <small class="text-muted">
                    ...
                    {{ $producto->lotes->count() }} lote(s) encontrado(s)
                </small>
                    <a href="{{ route('productos.reponer', $producto->idProducto) }}" class="btn btn-success btn-sm">
